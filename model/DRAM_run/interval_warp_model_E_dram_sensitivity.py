...
#def multi_RR(nonoverlap_insts,warp_numbers):
    def IPC_full(self):
        ...
        result=open('GPUMech_'+str(self.dram_bandwidth),'a')
       ...
       # result.write(str(Our_model_ipc)+','+str(self.total_instruction_counts)+'\n')
        ...
        delay_result=open('MDM-Queue_'+str(self.dram_bandwidth),'a')
        ...
        new_MSHR_result=open('MDM_'+str(self.dram_bandwidth),'a')
